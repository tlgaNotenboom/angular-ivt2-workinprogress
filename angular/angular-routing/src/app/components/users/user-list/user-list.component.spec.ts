...
import { UserService } from 'src/app/users/userservice';
import { asyncData } from 'src/testhelpers';

const serviceSpy = jasmine.createSpyObj('UserService', ['AllUsersFromApi']);
...
describe('UsersListComponent', () => {
  ...
  beforeEach(() => {
    ...
    serviceSpy.AllUsersFromApi.and.returnValue(asyncData(users));
  ...
  it('should use values from service', () => {

    fixture.detectChanges();

    const uiElement: HTMLElement = fixture.nativeElement;

    const length = uiElement.querySelector("tbody").textContent.split("tr").length;
  ...
  it('handleError', fakeAsync(() => {
    ...
    serviceSpy.AllUsersFromApi.and.returnValue(throwError('Oops'));
